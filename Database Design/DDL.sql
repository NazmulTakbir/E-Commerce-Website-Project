...
PICTURE BLOB NOT NULL,
PLACE_IN_WEBSITE VARCHAR2(50) NOT NULL,
...
CONSTRAINT ORDERED_ITEMS_FK1 FOREIGN KEY(PRODUCT_ID, SELLER_ID) REFERENCES PRODUCT(PRODUCT_ID, SELLER_ID),//product unit
CONSTRAINT ORDERED_ITEMS_FK2 FOREIGN KEY(SELLER_ID) REFERENCES SELLER(SELLER_ID),//bad
CONSTRAINT ORDERED_ITEMS_FK3 FOREIGN KEY(ORDER_ID) REFERENCES CUSTOMER_ORDER(ORDER_ID)
);
