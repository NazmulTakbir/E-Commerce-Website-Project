...
CONSTRAINT ORDERED_ITEMS_FK1 FOREIGN KEY(PRODUCT_ID, SELLER_ID) REFERENCES PRODUCT(PRODUCT_ID, SELLER_ID),
CONSTRAINT ORDERED_ITEMS_FK2 FOREIGN KEY(SELLER_ID) REFERENCES SELLER(SELLER_ID),
