...
EXPECTED_TIME_TO_DELIVER VARCHAR2(10) NOT NULL,
PRICE NUMBER NOT NULL,
CONSTRAINT PRODUCT_HISTORY_PK PRIMARY KEY(PRODUCT_ID , SELLER_ID, END_DATE),
CONSTRAINT PRODUCT_HISTORY_FK1 FOREIGN KEY(PRODUCT_ID, SELLER_ID) REFERENCES PRODUCT(PRODUCT_ID, SELLER_ID)
);
